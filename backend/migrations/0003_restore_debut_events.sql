-- Migration 0003: Restore all debut_events including 김밍령 (evt_2026_12)
...
-- Restore Creator Profiles (아롱띠, 헤티, 마테, 담하로, 바쿠, 김밍령, 루하, 치즈치즈)
...
VALUES 
  ...
  (12, 'kimmingryung', '김밍령', 'https://images.unsplash.com/photo-1517841905240-472988babdf9?w=150&auto=format&fit=crop&q=80', 'https://images.unsplash.com/photo-1517841905240-472988babdf9?w=150&auto=format&fit=crop&q=80', '개인세', 'INDIE', '김밍령 치지직 데뷔 방송', DATETIME('now'), DATETIME('now')),
...
-- Restore Debut Events (김밍령 포함 8건)
...
VALUES 
  ...
  ('evt_2026_12', 12, 'FIRST_DEBUT', '김밍령 데뷔 방송', '김밍령 데뷔 방송', '2026-07-13T17:00:00.000Z', 'Asia/Seoul', 'PUBLISHED', 'SOURCE_VERIFIED'),
...
VALUES 
  ...
  ('link_2026_12', 'evt_2026_12', 'CHZZK', 'https://chzzk.naver.com/video/14105462', 1),
