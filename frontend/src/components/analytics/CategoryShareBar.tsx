      ...
      <div className="flex items-center justify-between gap-3 mb-4">
        ...
        {onNavigateToCategory && (
          <button
            ...
            className="flex items-center gap-1.5 text-xs font-semibold text-[#2563EB] hover:text-blue-700 transition-colors cursor-pointer"
          >
            ...
            <div key={cat.groupId} className="space-y-1.5">
              <div className="flex items-center justify-between text-xs">
                ...
                <div className="flex items-center gap-3 text-[11px]">
                  <span className="text-blue-600 font-medium">시청 수요: {viewerPercent}%</span>
                  <span className="text-emerald-600 font-medium">방송 공급: {livePercent}%</span>
                </div>
              </div>

              {/* 이중 비교 프로그레스 바 */}
              <div className="h-3 w-full bg-slate-100 rounded-full overflow-hidden flex flex-col justify-center gap-0.5 p-0.5">
                <div
                  className="h-1 bg-gradient-to-r from-blue-600 to-indigo-500 rounded-full transition-all duration-500"
