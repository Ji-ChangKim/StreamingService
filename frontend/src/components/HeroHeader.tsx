...
export function HeroHeader({
  ...
  return (
    <div className="py-6 sm:py-8 flex flex-col items-center justify-center text-center space-y-5 w-full max-w-5xl mx-auto">
      ...
      {/* 2. 통계 카드 목록 (가로 스크롤 제거 및 자동 줄바꿈 flex-wrap 적용) */}
      <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-2.5 w-full px-2">
        {/* 상시 노출 1: {N}월 데뷔 */}
        <div className="bg-white rounded-[12px] border border-[#CBD5E1] shadow-2xs px-3.5 sm:px-4 py-2 text-center shrink-0 min-w-[95px] w-auto hover:border-[#2563EB] transition-all">
          ...
          <div className="text-base sm:text-lg font-extrabold text-[#2563EB] font-mono flex items-baseline justify-center gap-0.5">
        ...
        {/* 상시 노출 2: {A}월 {B}주차 데뷔 */}
        <div className="bg-white rounded-[12px] border border-[#CBD5E1] shadow-2xs px-3.5 sm:px-4 py-2 text-center shrink-0 min-w-[95px] w-auto hover:border-[#0F172A] transition-all">
          ...
          <div className="text-base sm:text-lg font-extrabold text-[#0F172A] font-mono flex items-baseline justify-center gap-0.5">
        ...
        {dynamicCards.map((card) => (
          <div
            key={card.label}
            className="bg-white rounded-[12px] border border-[#CBD5E1] shadow-2xs px-3.5 sm:px-4 py-2 text-center shrink-0 min-w-[95px] w-auto hover:border-[#2563EB] transition-all"
          >
            <span className="text-[10px] sm:text-[11px] font-bold text-[#64748B] block mb-0.5 whitespace-nowrap">{card.label}</span>
            <div className={`text-base sm:text-lg font-extrabold font-mono flex items-baseline justify-center gap-0.5 ${card.color}`}>
